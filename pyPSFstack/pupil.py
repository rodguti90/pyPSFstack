...
class Pupil():
    ...
    def __init__(self, aperture_size, computation_size, N_pts):
        ...
        self.N_pts = N_pts
        self.pupil_params = []
        self.grad_pupil_params = []
        self.N_pupil_params = 0
    ...
    def activate_parameters_optimization(self):
        self.optimization_on = True
        self.N_pupil_params = len(self.pupil_params)

    def generate_pupil_array(self):       
        raise NotImplementedError("Please Implement this method")

    def compute_parameters_gradient(self):
        raise NotImplementedError("Please Implement this method")
